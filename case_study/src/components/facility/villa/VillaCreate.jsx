...
function VillaCreate() {
    ...
    const createVilla = async (data) => {
        ...
        const res = await homeService.createFacility(data, 0);
        if (res.status === 201) {
            navigate("/");
    ...
    return (
        <div className="container mt-5">
            <h2 className="mb-4">Create Villa</h2>
            <Formik
                ...
                <Form>
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                <label htmlFor="size" className="form-label">Size of pool</label>
                    ...
                    <Link to="/" className="btn btn-secondary ms-2">Back to villa list</Link>
                </Form>
            </Formik>
        </div>
    );
